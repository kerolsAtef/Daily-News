...
class CategoryController {
  static Future<List<NewsModel>> getCategories(String category) async {
    List<NewsModel> l = <NewsModel>[];
    Uri uri = Uri.parse(
        "https://newsapi.org/v2/top-headlines?category=$category&apiKey=b47c5e837e464b69b993eb7316857461");
